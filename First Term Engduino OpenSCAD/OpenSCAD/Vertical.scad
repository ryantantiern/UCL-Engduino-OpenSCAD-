//Design when Engduino is vertical
...
module Renderbody(){ 
     ...
     addText(text_height, [xBase - 34, yBase - 15,zBase], [0,0,-90], "College");
     addText(text_height, [xBase - 46, yBase - 15,zBase], [0,0,-90], "London");
}
...
Renderbody();
rotate([-90,0,45] )translate([59,-(yUSB + zUSB_case+zHinge+spacing) -(zBase -(zUSB_case)) , 27])  RenderUSBholder();
translate([10, 59, zBase+zHinge/2 ]) rotate([0,0,45]) HingePole();
